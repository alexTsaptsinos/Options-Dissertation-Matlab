function [europeanValue,martApproximation,martStdError,martRelativeStdError,martApproximation2,martStdError2,martRelativeStdError2,totaltime] = gameOptionKuhn(S0);
...
N3 = 1*10^5; % sample path pairs for lower bound valuation
N4 = 5*10^3; % subloops
...
martApproximation = mean(minimums)
...
martApproximation2 = mean(maximums)
