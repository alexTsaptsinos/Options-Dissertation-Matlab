function [controlLowerBound,europeanValue,upperBound,upperStdError,upperRelativeStdError,upperTime,CI] = singleAmericanAB4(S0);
%% Anderson Broadie Simulation with variate reduction techniques attempt 2
% USES COMPARISON WITH LOWER BOUND ESTIMATE FOR SUB-OPTIMALITY CHECKING
